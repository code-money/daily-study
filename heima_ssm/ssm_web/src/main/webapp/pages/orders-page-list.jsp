<%@ page import="cn.zyz.entity.Orders" %>
...
<body class="hold-transition skin-purple sidebar-mini">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
							...
							<c:forEach begin="1" step="1" end="${pageInfo.pages}" var="pagNum">
								<li><a href="${pageContext.request.contextPath}/orders/findAll?page=${pagNum}&size=${pageInfo.pageSize}">${pagNum}</a></li>
							</c:forEach>
	...
	<script>
		//入口函数，设置页数大小下拉框的当前选中项为pageInfo.pageSize
		$(function () {
			value =${pageInfo.pageSize}
			$("#changePageSize").val(value)
		})
