package cn.zyz.demo07.Properties;
...
//        show02();
    ...
    */
    private static void show01() throws Exception {
        Properties properties = new Properties();
        properties.setProperty("库里","mvp");
        properties.setProperty("德古拉格林","pvm");
        properties.setProperty("克莱","good");

        //使用stringPropertyNames获取properties集合的键
